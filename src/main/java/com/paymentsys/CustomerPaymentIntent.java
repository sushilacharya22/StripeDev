...
public class CustomerPaymentIntent {
	
public JsonObject CreatePaymentIntent (String apiKey, String amount, String currencyCd, String paymentMethod, String customerId) {
		
		Stripe.apiKey = apiKey;
		String PaymentIntentId = null;
		Customer customer = new Customer();
		System.out.println(customerId);
		System.out.println(customer.getInvoiceSettings());
		try {
		...
		//customer.getDefaultSourceObject().getId();
